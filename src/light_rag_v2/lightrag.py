...
from src.light_rag_v2.retriever import LightRAGRetriever
from src.light_rag_v2.utils.gexf_loader import load_gexf_to_storage
from src.light_rag_v2.prompt import PROMPT_ANSWER_GENERATION
...
class LightRAG:
    ...
    def __init__(self):
        ...
        self.entity_vector_storage = VectorStorage(collection_name="light_rag_v2_entities")
        self.relation_vector_storage = VectorStorage(collection_name="light_rag_v2_relations")
        self.chunk_vector_storage = VectorStorage(collection_name="light_rag_v2_chunks")
