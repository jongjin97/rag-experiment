...
- **최종 검증 성능 (Ragas)**:
    - **[검색 품질 - 기존 데이터셋]**
        ...
        - **Recall**: **0.896**
    - **[생성 품질 - 신규 평가 데이터셋]**
        - **Faithfulness**: 0.7957 ➔ **0.8758 (+0.0801)**
        - **Answer Relevancy**: 0.7294 ➔ **0.7729 (+0.0435)**
        - 💡 **Insight**: 0점 케이스를 디버깅하여 검색 문서가 없는 방어 거부 사례와 프롬프트의 과도한 보수성(Over-conservatism)을 제어하자 두 지표 모두 극적인 상승을 이뤄냈습니다. (실제 체감 품질은 점수 이상입니다.)
